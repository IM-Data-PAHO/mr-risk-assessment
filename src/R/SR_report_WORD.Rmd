...
date: "![](Dashboard/www/country_flag.png){width=60%}"
output:
...
# The dashboard's reset-view button (leaflet.extras::addResetMapButton) is only
# meaningful on a live widget. These maps get flattened to static PNGs via
# mapshot(), where the button would just be a frozen, non-clickable icon.
strip_reset_button <- function(map) {
  map$x$calls <- Filter(function(call) !(call$method %in% c("addEasyButton", "onRender")), map$x$calls)
  map
}
...
cut_offs_table <- data.frame(
  cat=c(lang_label("table_cut_offs_LR"),lang_label("table_cut_offs_MR"),
        lang_label("table_cut_offs_HR"),lang_label("table_cut_offs_VHR")),
  pts=c(
    paste0(lang_label("table_cut_offs_btwn")," ",0," ",lang_label("and")," ",24," ",lang_label("table_cut_offs_unit")),
    paste0(lang_label("table_cut_offs_btwn")," ",lim_bajo," ",lang_label("and")," ",lim_mediano-1," ",lang_label("table_cut_offs_unit")),
    paste0(lang_label("table_cut_offs_btwn")," ",lim_mediano," ",lang_label("and")," ",lim_alto-1," ",lang_label("table_cut_offs_unit")),
    paste0(lang_label("table_cut_offs_btwn")," ",lim_alto," ",lang_label("and")," ",100," ",lang_label("table_cut_offs_unit"))
  )
)
...
#### `r title_name_figure` 2c: `r lang_label("title_figure_2_SPR1")`, `r ref_country_name`, `r YEAR_5`.
...
\newpage
#### `r title_name_figure` 2d: `r lang_label("title_figure_2_SPR2")`, `r ref_country_name`, `r YEAR_5`.
...
fig_map <- cal_plot_map_data(LANG_TLS,COUNTRY_NAME,YEAR_LIST,ZERO_POB_LIST,CUT_OFFS,country_shapes,calidad_data,"case_class",rep_label_all,0,admin1_geo_id_df)
fig_map <- tidy_map(fig_map)
...
<!-- \newpage -->
#### `r title_name_figure` 4c: `r lang_label("title_figure_4d")`, `r ref_country_name`, `r YEAR_5`.
...
#### `r title_name_figure` 4d: `r lang_label("title_figure_4e")`, `r ref_country_name`, `r YEAR_5`.
